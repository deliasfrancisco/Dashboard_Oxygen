...
namespace Dashboard_OxygenWeb.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly Dashboard_OxygenWebDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = Dashboard_OxygenWebConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Dashboard_OxygenWebDbContext context)
        {
            _context = context;
        }
